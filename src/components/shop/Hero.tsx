...
export function Hero({
  ...
  return (
    <section className="relative h-[80vh] min-h-[560px] w-full overflow-hidden bg-ink-deep">
      ...
      <div className="relative z-10 flex h-full flex-col items-center justify-center px-6 text-center text-paper [text-shadow:0_1px_3px_rgba(0,0,0,0.3)]">
        <h1 className="max-w-3xl font-serif text-5xl leading-tight tracking-tight md:text-6xl">
          {title}
        </h1>
        <p className="mt-6 max-w-xl text-lg leading-relaxed text-paper/90">{subtitle}</p>
